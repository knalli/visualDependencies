 ...
 */
public abstract class OracleProcedureSqlParserImpl extends AbstractProcedureSqlParser {
	...
	public OracleProcedureSqlParserImpl(final Vendor vendor) {
		super(vendor);
		initialize();
	}
	...
	public boolean parse(final DatabaseProcedure procedure) {
		...
		try {
			...
			log.log(Level.WARNING, e.getLocalizedMessage()
					+ String.format("Procedure (Original): %s; Procedure (Transformed): %s", body,
	...
	public void initializeProcedureSqlResults() {
		usedTables.clear();

...
/**
 * Abstract class for a procedure sql parser.
 * 
 * @author Marc Kastleiner
 */
abstract public class AbstractProcedureSqlParser extends Observable implements IProcedureSqlParser {
	/**
	 * implemented database vendor
	 */
	protected final Vendor vendor;

	public AbstractProcedureSqlParser(final Vendor vendor) {
		this.vendor = vendor;
	}
